...
OUTPUT_DIR=/pdo/astronet-data/models/vetting/experimental/pablomer/oct2025_cadencebin/$DATE/student-2k-nopretrained/
...
EVAL_DATA_DIR=/pdo/astronet-data/data/tfrecords/oct2025_cadencebin
