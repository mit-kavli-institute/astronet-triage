...
# Streamlit UI
st.set_page_config(page_title="ExoDash - Labelling", layout="wide")
st.title("Manual Labelling")
...
if 'astro_row' not in st.session_state:
    sampled_ids = ensemble_results['astro_id'].sample(frac=1, random_state=42).tolist()
