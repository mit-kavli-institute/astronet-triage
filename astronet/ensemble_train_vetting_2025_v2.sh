...
do
    ...
    PYTHONPATH=$CODE_DIR LD_LIBRARY_PATH=/pdo/users/cshallue/miniconda3/lib \
    /pdo/users/cshallue/miniconda3/bin/python $CODE_DIR/astronet/train.py \
...
LD_LIBRARY_PATH=/pdo/users/cshallue/miniconda3/lib \
    /pdo/users/cshallue/miniconda3/bin/python \
