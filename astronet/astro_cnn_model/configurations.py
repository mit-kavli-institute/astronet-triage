...
def final_alpha_1_tuned():
    ...
    config['hparams'] = {'adam_epsilon': 6.816179817920565e-07,
 'aux_inputs': ['Period',
                'Duration',
                'Transit_Depth',
                'Tmag',
 ...
 'time_series_hidden': {'global_view': {'cnn_block_filter_factor': 1.91786771926268,
                                        'cnn_block_size': 2,
                                        'cnn_initial_num_filters': 18,
                                        'cnn_kernel_size': 5,
                                        'cnn_num_blocks': 1,
                                        'convolution_padding': 'same',
                                        'extra_channels': ['global_std',
                                                           'global_mask',
                                                           'global_transit_mask',
                                                           'global_view_0.3',
                                                           'global_view_5.0'],
                                        ...
                                        'pool_strides': 2,
                                        'separable': True},
                        'global_view_double_period': {'cnn_block_filter_factor': 0.8012713491221781,
                                                      'cnn_block_size': 2,
                                                      'cnn_initial_num_filters': 50,
                                                      'cnn_kernel_size': 3,
                                                      'cnn_num_blocks': 2,
                                                      'convolution_padding': 'same',
                                                      'extra_channels': ['global_view_double_period_0.3',
                                                                         'global_view_double_period_5.0'],
                                                      'pool_size': 6,
                                                      'pool_strides': 1,
                                                      'separable': False},
                        'local_view': {'cnn_block_filter_factor': 1.8539157128605275,
                                       'cnn_block_size': 2,
                                       'cnn_initial_num_filters': 50,
                                       'cnn_kernel_size': 4,
                                       'cnn_num_blocks': 3,
                                       'convolution_padding': 'same',
                                       'extra_channels': ['local_std',
                                                          'local_mask',
                                                          'local_view_0.3',
                                                          'local_view_5.0',
                                                          'local_view_odd',
                                       ...
                                       'pool_strides': 2,
                                       'separable': False},
                        'sample_segments_local_view': {'cnn_block_filter_factor': 0.20742222986127115,
                                                       'cnn_block_size': 1,
                                                       ...
                                                       'pool_strides': 2,
                                                       'separable': False},
                        'sample_segments_view': {'cnn_block_filter_factor': 0.35437138028042037,
                                                 'cnn_block_size': 1,
                                                 'cnn_initial_num_filters': 63,
                                                 'cnn_kernel_size': 5,
                                                 'cnn_num_blocks': 4,
                                                 'convolution_padding': 'same',
                                                 'extra_channels': ['sample_segments_view_0.3',
                                                                    'sample_segments_view_5.0'],
                                                 'multichannel': True,
                                                 'pool_size': 7,
                                                 'pool_strides': 2,
                                                 'separable': True},
                        'secondary_view': {'cnn_block_filter_factor': 0.3482832940681012,
                                           'cnn_block_size': 1,
