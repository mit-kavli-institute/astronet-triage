...
DATA_DIR=/pdo/astronet-data/data/tfrecords/dec2025_cad_scat_v5_aug/10x_0p1_with_new_features/
...
OUTPUT_DIR=/pdo/astronet-data/models/vetting/experimental/dimond/$DATE/$ENSEMBLE_NAME-new-features/
