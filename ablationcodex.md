...
### `astronet/astro_cnn_model/astro_cnn_model_global_local_ablation.py`
...
### `astronet/astro_cnn_model/configurations_vetting_global_local_ablation.py`
...
- Executed:
  - `bash /pdo/users/pablomer/Astronet-Triage/astronet/ensemble_train_vetting_2025_global_local_ablation.sh`
