...
"""Vetting configs for scalar-input ablation (time-series-only)."""
...
def pablomer():
  ...
  config = {
      ...
      "inputs": {
          ...
          "features": copy.deepcopy(triage_ts_features),
      },
      "hparams": {
          "batch_size": 512,
          "learning_rate": 1e-5,
          ...
          "aux_inputs": [],
          "time_series_hidden": copy.deepcopy(triage_config["hparams"]["time_series_hidden"]),
      },
  }
